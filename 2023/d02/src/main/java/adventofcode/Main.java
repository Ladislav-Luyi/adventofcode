...
//            System.out.println(game.getGameId() + " " + game.getBags());
            System.out.println(
                game.isPlayable(bag)
            );
        }
        System.out.println(Game.getPlayableGames()); // 2278 correct answer
    ...
    private static void part2() {
        ...
        System.out.println(Game.getSumOfPowerOfMaxColors());
        // 2278 correct answer
    }
